...
class Chemical(_object):
    ...
    if _newclass:m_mw = _swig_property(_Chemical.Chemical_m_mw_get, _Chemical.Chemical_m_mw_set)
    __swig_setmethods__["m_K_ow"] = _Chemical.Chemical_m_K_ow_set
    __swig_getmethods__["m_K_ow"] = _Chemical.Chemical_m_K_ow_get
    if _newclass:m_K_ow = _swig_property(_Chemical.Chemical_m_K_ow_get, _Chemical.Chemical_m_K_ow_set)
